...
<title>Publication Actualités</title>
...
{
    if (!empty($_POST['photo']) AND !empty($_POST['categorie']) AND !empty($_POST['titre']) AND !empty($_POST['auteur'])){
        ...
        publierArticle($photo, $categorie, $titre, $auteur);
    }
